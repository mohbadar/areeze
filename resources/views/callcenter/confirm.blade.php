                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="related_office" class="form-control" required data-validation-required-message="This field is required"  value="{{$shekayat->related_office}}"> </div>
                                                {{-- <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div>--}}
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" name="national_identity_card_NO" data-validation-match-match="password" class="form-control" required value="{{$shekayat->national_identity_card_NO}}"> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="date" name="date" class="form-control"
                                                               required data-validation-required-message="This field is required" value="{{$shekayat->date}}"> </div>
                                                </div>
                                            ...
                                            <form class="form-horizontal"  method="POST" action="{{route('confirm.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-md-12">  تاریخ مسترد </label>
                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-12">دلایل مسترد </label>
                                                        <div class="col-md-12">
                                                ...
                                                <div class="btn btn-success btn-lg mt-8  text-center" >
