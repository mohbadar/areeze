        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">لست  ولایت </h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item" aria-current="page"> ولایت </li>
                                        ...
                                        @foreach($provinces as $province)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('province.edit',$province->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center"> ولایت</a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">  ولایت </h4>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('province.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"> ولایت </label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="ولایت  " name="name">
                            </div>
