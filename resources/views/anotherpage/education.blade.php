        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">لست تحصیل </h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item" aria-current="page"> تحصیل</li>
                                        ...
                                        @foreach($degrees as $degree)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('degree.edit',$degree->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                                                        <i  class="fa fa-pencil-square" style="color: #fff !important;" ></i>
                                                    </a>
                                                    <form action="{{route('degree.destroy',$degree->id)}}" method="post" style="display: inline">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center">تحصیل </a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">   درجه تحصیل</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('degree.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-md-12"> درجه تحصیل</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder=" درجه تحصیل" name="name">
                            </div>
