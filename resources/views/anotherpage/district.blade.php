        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">تمام رهنمایی ها </h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item" aria-current="page"> رهنمایی</li>
                                    <li class="breadcrumb-item active" aria-current="page">لست رهنمایی</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 style="text-align: center;">لست  ولایت </h3>
                                        ...
                                        @foreach($districts as $district)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('districts.edit',$district->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center"> ولسوالی</a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">  ولسوالی  </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('districts.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-md-12">ولسوالی </label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="ولسوالی   " name="name">
                            </div>
