        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">لست نوعیت</h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item" aria-current="page">نوعیت</li>
                                    <li class="breadcrumb-item active" aria-current="page">لست نوعیت</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        @foreach($types as $type)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('type.edit',$type->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center">نوعیت جدید</a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"> نوعیت جدید</h4>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('type.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"> نوعیت</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder=" نوعیت" name="name">
                            </div>
