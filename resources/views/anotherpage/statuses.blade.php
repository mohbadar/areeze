                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        ...
                                        @foreach( $statuses as $statuse)
                                            <tr>
                                                <td>{{$statuse->id}}</td>
                                                <td>{{$statuse->status_name}}</td>
                                                <td class="text-center">
                                                    <a href="{{route('statuses.edit',$statuse->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                                                        <i  class="fa fa-pencil-square" style="color: #fff !important;" ></i>
                                                    </a>
                                                    <form action="{{route('statuses.destroy', $statuse->id)}}" method="post" style="display: inline">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center">حالت</a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">حالت </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('statuses.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-md-12">حالت </label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="حالت " name="name">
                            </div>
