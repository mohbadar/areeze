        ...
        <div class="container-full">
            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title">لست وزارت</h3>
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                    <li class="breadcrumb-item" aria-current="page">وزارت</li>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        ...
                                        @foreach($ministries as $ministrie)
                                            <tr>
                                                <td>{{$ministrie->id}}</td>
                                                <td>{{$ministrie->name}}</td>
                                                <td class="text-center">
                                                    <a href="{{route('ministries.edit',$ministrie->id)}}"  class="btn btn-warning"  title="" data-original-title="Edit">
                                                        <i  class="fa fa-pencil-square" style="color: #fff !important;" ></i>
                                                    </a>
                                                    <form action="{{route('ministries.destroy',$ministrie->id)}}" method="post" style="display: inline">
                                                        <input type="hidden" name="_method" value="delete">
                                                        {!! csrf_field() !!}
                                                        <button onclick="return confirm('Are you sure?')" type="submit" class="close-icon btn btn-primary btn-outline" ><i class="fa fa-trash"> </i></button>
                                                    </form>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="box no-shadow">
                            <div class="box-body">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg mt-10 d-block text-center"> وزارت جدید</a>
                            </div>
                        </div>
                        <!-- /. box -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">  وزارت جدید</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{route('ministries.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="col-md-12">نام وزارت</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="نام وزارت" name="name">
                            </div>
